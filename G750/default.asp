      ...
      <section id="G750" class="row">
        ...
        <div class="row">
          ...
          <div class="columns medium-5 medium-pull-7 padding-bottom-medium-up">
            ...
            <ul class="list-series">
              <li>Intel<sup>&reg;</sup> Core<sup>&trade;</sup> i7-4700HQ processor</li>
              <li>Dual fans with copper heat sinks keep temperatures low for guaranteed stability </li>
        ...
        <div class="series-box row">
          ...
          <div class="columns medium-2">
            <h3 class="series-label">G750JZ</h3>
          ...
          <div class="columns medium-10">
            ...
            <div class="row red-box">
              ...
              <div class="columns medium-9">
                ...
                <ul class="list-series">
                  <li>NVIDIA<sup>&reg;</sup> GeForce<sup>&reg;</sup> GTX 880M 4GB with Optimus Technology</li>
                  <li>Killer Wireless-N1202 delivers fast data-transfer speeds</li>
                </ul><!-- .list-series -->
        ...
        </div><!-- .series-box.row (G750JZ) -->

        <div class="series-box row">

          <div class="columns medium-2">
            <h3 class="series-label">G750JS</h3>
          </div><!-- .columns.medium-2 -->
        ...
        </div><!-- .series-box.row (G750JS) -->

        <div class="series-box row">

          <div class="columns medium-2">
            <h3 class="series-label">G750JM</h3>
          </div><!-- .columns.medium-2 -->
