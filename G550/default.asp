      ...
      <section id="G550" class="row">
        ...
        <div class="row">
          ...
          <div class="columns medium-7 medium-push-5 text-center padding-bottom-medium-up">
            <img src="/us/site/g-series/assets/img/series/G550/kv-main.jpg" alt="G550" class="kv">
          </div>

          <div class="columns medium-5 medium-pull-7 padding-bottom-medium-up">

            <h2><a href="/us/site/g-series/" title="G Series Home">« G Series</a> \ G550 Series</h2>

            <p class="screen-size">15.6" FHD (1920 x 1080) IPS display, Matte</p>

            <div class="clearfix"></div>

            <ul class="list-series">
              <li>Remarkable detail and 178-degree viewing on a 15.6-inch Full HD IPS panel</li>
              <li>Dual independent intelligent fans for maximum cooling efficiency and minimum noise</li>
              <li>ASUS TurboMaster GPU overclocking technology delivers 5% performance boost</li>
              <li>Majestic red backlit keyboard with adjustable brightness level</li>
              <li>Enhanced audio experience with ROG AudioWizard and an external subwoofer</li>
            </ul><!-- .list-series -->
        ...
        <div class="series-box row">

          <div class="columns medium-2">
            <h3 class="series-label">G550JK</h3>
          </div><!-- .columns.medium-2 -->
          ...
          <div class="columns medium-10">
            ...
            <div class="row red-box">
              ...
              <div class="columns medium-9">
                ...
                <ul class="list-series">
                  <li>Intel<sup>&reg;</sup> Core<sup>&trade;</sup> i7-4700HQ processor / Intel<sup>&reg;</sup> Core<sup>&trade;</sup> i7-4710HQ processor</li>
                  <li>NVIDIA<sup>&reg;</sup> GeForce<sup>&reg;</sup> GTX 850M 2GB with Optimus Technology</li>
                </ul><!-- .list-series -->
            ...
            <div class="row wtb-box">

              <div class="columns medium-9 last">
          ...
          </div><!-- .columns.medium-10 -->

        </div><!-- .series-box.row (G550JK) -->
