    <nav>
      ...
      <div class="container">
        ...
        <ul class="list-inline logo">
          <li><a href="http://www.asus.com/us" title="ASUS USA" class="external"><img src="/us/site/g-series/assets/img/logo-asus-2x.jpg" alt="ASUS ROG" width="120"></a></li>
          <li class="rog"><a href="http://rog.asus.com/" title="ASUS ROG" class="external"><img src="/us/site/g-series/assets/img/logo-rog-2x.jpg" alt="ASUS ROG" width="77"></a></li>
        </ul>
        ...
        <div id="menu" class="dropdown-menu">
          <ul class="list-unstyled dropdown-list">
            ...
            <li class="dropdown-item"><a href="/us/site/g-series/#design" title="Design"><span class="arrow">&raquo;</span> Design</a></li>
            ...
            <li class="dropdown-item"><a href="/us/site/g-series/G550" title="G550 Series"><span class="arrow">&raquo;</span> Where To Buy - G550</a></li>
          </ul>
        </div><!-- .dropdown-menu -->
